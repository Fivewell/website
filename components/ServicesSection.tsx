      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Fivewell Africa brings together specialists in Agricultural Engineering, Environmental Science, 
            Agribusiness Economics, Agronomy, and Agricultural Extension.
          </p>
        ...
        >
          <div className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl border border-gray-700">
            <p className="text-gray-300 leading-relaxed text-lg">
              Our work in agriculture, environment, and food systems has strengthened our understanding 
              of the continent&apos;s diverse contexts and the practical solutions needed to drive lasting change.
            </p>
          </div>
        </motion.div>
      </div>
