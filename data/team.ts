...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    detailedBio: "Fredrick is an Agricultural and Biosystems Engineer specializing in sustainable production systems, precision agriculture, and data-driven decision support for farming and agri-business. He holds advanced training in agricultural technologies and desert farming systems from Israel's Arava region, where he gained hands-on experience in irrigation, greenhouse management, mechanization, and integrated livestock-crop systems.\n\nFredrick is passionate about advancing agri-tech solutions that build resilience, efficiency, and environmental responsibility and is driven by a belief that sustainable agriculture is not just a practice, it is a pathway to dignity, food security, and economic transformation. Outside of work, he enjoys exploring emerging technologies, mentoring young professionals, and spending time in nature.\n\nAt Fivewell Africa, he brings on board skills in Projects management, Research, Analytics, and Innovation, where he focuses on developing practical solutions that strengthen climate resilience, improve resource efficiency, and expand market opportunities for farmers and agri-enterprises. His work bridges technology, sustainability, and community impact; from digital agriculture tools and GIS-based farm planning to circular economy solutions and capacity-building programs for producers and SMEs.",
